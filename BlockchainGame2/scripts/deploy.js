...
async function main() {
  ...
  const CourseCertNFT = await hre.ethers.getContractFactory("CourseCertificateNFT");
  const nftDeployed2  = await CourseCertNFT.deploy("CourseCertificateNFT", "CCNFT","localhost:3001/metadata/ccnft/");

  console.log("CourseCertificateNFT Contract :", nftDeployed2 );
}
